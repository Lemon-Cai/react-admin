...
export interface OidcUser extends UserInfo {
  roleList?: any[]
  is_oidc_user: true
}
...
export const OidcSetting: UserManagerSettings = {
...
export const userManager = new UserManager(OidcSetting)
...
// 限时函数
const timeout = (prom: any, time: any) =>
